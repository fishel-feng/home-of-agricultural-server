  ...
  _createClass(UserController, [{
    ...
    value: function () {
      var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
        var _ctx$request$body5, nickName, gender, age, job, location, description, headImage, status;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                _ctx$request$body5 = this.ctx.request.body, nickName = _ctx$request$body5.nickName, gender = _ctx$request$body5.gender, age = _ctx$request$body5.age, job = _ctx$request$body5.job, location = _ctx$request$body5.location, description = _ctx$request$body5.description, headImage = _ctx$request$body5.headImage;
                _context5.next = 4;
                return this.ctx.service.user.modifyUserInfo(nickName, gender, age, job, location, description, headImage);
